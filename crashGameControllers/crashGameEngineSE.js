...
class CrashGameEngine {
  ...
  async start() {
    ...
    const HandleCountDown = (async (e) => {
      ...
      this.timeLoop = setInterval(() => {
        if (timeSec.toFixed(2) <= 0.1) {
          ...
          timeSec -= 0.01;
          load_animate -= 0.198
          // this.broadcast("v_five", 0)
          // this.broadcast("v_default", true)
          // this.broadcast("v_two", 0)
          // this.broadcast("v_seven", 0)
          // this.broadcast("v_three", 0)
          // this.broadcast("v_nine", 0)
          // this.broadcast("v_twenty", 0)
          this.broadcast("countdown", timeSec)
          this.broadcast("load-animation", load_animate)
          this.broadcast("game_id", detail.game_id)
          // this.broadcast("v_ten", 0)
          // this.broadcast("v_hundred", 0)
          // this.broadcast("v_FiveHundred", 0)
          // this.broadcast("v_thousand", 0)
          // this.broadcast("v_fivety", 0)
          // this.broadcast("v_Twohundred", 0)

          // this.broadcast("h_hundred", 0)
          // this.broadcast("h_eighty", 0)
          // this.broadcast("h_sixty", 0)
          // this.broadcast("h_thirthy", 0)
          // this.broadcast("h_fourty", 0)
          // this.broadcast("h_twenty", 0)
          // this.broadcast("h_eighteen", 0)
          // this.broadcast("h_sixteen", 0)
          // this.broadcast("h_fourteen", 0)
          // this.broadcast("h_ten", 0)
          // this.broadcast("h_twelve", 0)
          // this.broadcast("h_eight", 78)
          // this.broadcast("h_six", 58)
          // this.broadcast("h_two", 18)
          // this.broadcast("h_four", 38)
        }
      }, 10);
    })
    ...
    //     }else{
    //         // this.broadcast("weekly-count-down", `${ days !== 0 ? days + "d" : ""} ${hours}h ${minutes}m ${seconds}s`)
    //     }
    // }
    // }
    ...
    //         }else{
    //             // this.broadcast("monthly-count-down", `${ days !== 0 ? days + "d" : ""} ${hours}h ${minutes}m ${seconds}s`)
    //         }
    //     }
    // }
